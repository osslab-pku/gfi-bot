...
up(){
    ...
    screen -dmS "$SCREEN_NAME_BACKEND" bash -c "cd ../ && GFIBOT_ENV=dev poetry run uvicorn gfibot.backend.server:app --host 0.0.0.0 --port ${GFIBOT_BACKEND_PORT} --reload --reload-dir gfibot/"
