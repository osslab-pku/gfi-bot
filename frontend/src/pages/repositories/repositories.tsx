...
import { GFIAlarm, GFIPagination, GFIProgressBar } from '../GFIComponents'
import { RepoGraphContainer } from './GFIRepoDataDemonstrator'
...
export const Repositories = () => {
	...
	const onPageBtnClicked = () => {
		if (checkIsNumber(pageFormInput)) {
			...
			if (pageInput > 0 && pageInput <= pageNums()) {
				...
				window.alert(
					'Out of page index, max page number is ' + pageNums()
				)
			}
		} else {
	...
	let [cardInfoListToDisplay, setCardInfoListToDisplay] =
						...
						<Row>
							<Col>
								<Alert variant={'success'}>
									<Alert.Heading>
										{' '}
										Data from {totalRepos} different GitHub
										repositories{' '}
									</Alert.Heading>
								</Alert>
							</Col>
